...
public class DropDownMenu extends LinearLayout {
    ...
    public void addViewToTabMenuView(View view) {
        tabMenuView.addView(view, tabMenuView.getChildCount());
    }
...
//        tab.setBackgroundColor(Color.BLUE);
        ...
        tab.setLayoutParams(new LayoutParams(10, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
        ...
        if (i < tabTexts.size() - 1) {
            ...
            view.setLayoutParams(new LayoutParams(dpTpPx(0f), ViewGroup.LayoutParams.MATCH_PARENT));
