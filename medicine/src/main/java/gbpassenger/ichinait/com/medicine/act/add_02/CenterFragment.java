...
import com.niuduz.richeditor_ding.ReadAcitvity;
...
//                startActivityForResult(intent, RICH_IMAGE_CODE);
         ...
         * 插入分割线
         */
        view.findViewById(R.id.action_split).
    ...
    private void showInsertLinkDialog() {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_insertlink, null);
